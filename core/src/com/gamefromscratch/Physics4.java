...
public class Physics4 extends ApplicationAdapter {
	...
	public void create() {
		...
		fixtureDef.filter.maskBits = WORLD_ENTITY|PHYSICS_ENTITY;	// Set First sprite to collide with both World and PHysics entities
		...
		fixtureDef2.filter.maskBits = WORLD_ENTITY|PHYSICS_ENTITY;	// Set First sprite to collide with both World and PHysics entities
